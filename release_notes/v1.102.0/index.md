...
**Editing multiple heuristic-v1 routers requires Auto Router access, which existing enterprise licenses with `allowed_features: ["*"]` already include.** Keep using your valid existing key when upgrading; you do not need a replacement key or an additional Auto Router license. Licenses that explicitly include `auto_router` also remove the limit. Without either grant, existing snapshots and unchanged defaults remain valid, but only one tuned router is allowed. See [PR #39952](https://github.com/BerriAI/litellm/pull/39952), [PR #40007](https://github.com/BerriAI/litellm/pull/40007), [PR #41684](https://github.com/BerriAI/litellm/pull/41684)
