  ...
  integrationsSidebar: [
      ...
      items: [
        {
          ...
          items: ['adding_provider/generic_prompt_management_api'],
        },
    ...
    },
    {
      ...
      link: {
        ...
        title: 'AI Tools',
        description:
          'Integrate LiteLLM with AI tools like OpenWebUI, Claude Code, and more',
        slug: '/ai_tools',
      },
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'doc',
          id: 'tutorials/scalekit_agentkit',
          label: 'Scalekit with LiteLLM',
        },
        {
          type: 'doc',
          id: 'tutorials/instructor',
          label: 'Instructor with LiteLLM',
        },
        {
          type: 'doc',
          id: 'langchain/langchain',
          label: 'LangChain with LiteLLM',
        },
    ...
    },
    {
      ...
      items: ['tutorials/claude_code_skills'],
    },
  ],
  ...
  tutorialSidebar: [
...

    {
      ...
      items: [
        ...
        },
        {
          type: 'category',
          label: 'Configuration',
          items: ['set_keys', 'proxy_auth', 'caching/all_caches'],
        },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              type: 'category',
              label: 'Models',
              items: ['proxy/ai_hub', 'proxy/model_compare_ui'],
            },
            {
              type: 'category',
            ...
            },
            {
              ...
              items: ['proxy/customer_usage', 'proxy/endpoint_activity'],
            },
            {
              type: 'category',
              label: 'Logs',
    ...
    },
    {
      ...
      items: [
        ...
        'providers/ovhcloud',
        {
          type: 'category',
          label: 'Perplexity AI',
          items: ['providers/perplexity', 'providers/perplexity_embedding'],
        },
        'providers/petals',
        'providers/poe',
        'providers/publicai',
        ...
        },
        {
          type: 'category',
          label: 'xAI',
          items: ['providers/xai', 'providers/xai_realtime'],
        },
...

    {
      ...
      link: {
        ...
        description:
          'Learn how to load balance, route, and set fallbacks (provider failover) for your LLM requests',
    ...
    // ── Guides ────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: ['completion/knowledgebase'],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'Retries, fallbacks (failover), mock responses, and budget controls',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'SSL, custom CA bundles, HTTP proxy settings, and per-service verification',
            slug: '/guides/security_network',
          },
          items: ['guides/security_settings'],
        },
      ],
    },
      ...
      items: [
        {
          ...
          link: {
            ...
            description:
              'Installation, playground, text completion, and mock completions',
        ...
        },
        {
          ...
          link: {
            ...
            title: 'Python SDK',
            description:
              'Tutorials using only the Python SDK — no proxy server required',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'Connect LiteLLM to Azure OpenAI, HuggingFace, TogetherAI, local models, and more',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'User and team management, SSO, SCIM, and routing rules',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'Prompt caching, passthrough APIs, realtime, guardrails, and PII masking',
        ...
        },
        {
          ...
          link: {
            ...
            description:
              'Logging, monitoring, benchmarking, and evaluation suites',
...
const autoRouterSidebar: SidebarsConfig = {
  autoRouterSidebar: [
    {
      type: 'doc',
      id: 'auto_router/index',
      label: 'Overview',
      className: 'autorouter-nav-item',
    },
    {type: 'doc', id: 'auto_router/setup', className: 'autorouter-nav-item'},
    {
      type: 'doc',
      id: 'auto_router/user_setup',
      className: 'autorouter-nav-item',
    },
    {
      type: 'doc',
      id: 'auto_router/recommended_configurations',
      className: 'autorouter-nav-item',
    },
    {
      type: 'doc',
      id: 'auto_router/benchmarks',
      className: 'autorouter-nav-item',
    },
    {
      type: 'doc',
      id: 'auto_router/prompt_caching',
      className: 'autorouter-nav-item',
    },
    {type: 'doc', id: 'auto_router/evaluate', className: 'autorouter-nav-item'},
    {
      type: 'doc',
      id: 'auto_router/feature_history',
      className: 'autorouter-nav-item',
    },
    {
      type: 'category',
      ...
      items: [
        {
          ...
          href: '/docs/proxy/auto_routing',
        },
        {
          type: 'link',
          label: 'Claude Code and Claude Desktop',
          href: '/docs/tutorials/claude_code_autorouter',
        },
        {
          type: 'link',
          label: 'lite autoroute',
          href: '/docs/learn/autorouter_cli',
        },
        {
          type: 'link',
          label: 'Prompt Cache Routing (Load Balancing)',
          href: '/docs/tutorials/claude_code_prompt_cache_routing',
        },
      ],
    },
  ],
