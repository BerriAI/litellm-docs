...
{
  "error": {
    "message": "Priority-based rate limit exceeded. Model: gpt-4o-mini, Priority: dev, Rate limit type: tokens, Model TPM: 1000, Model RPM: not configured, Remaining: 0, Model saturation: 52.8%",
...
{
  "error": {
    "message": "Model capacity reached for gpt-4o-mini. Priority: prod, Rate limit type: tokens, Model TPM: 1000, Model RPM: not configured, Remaining: 0",
    "type": "throttling_error",
    "code": "429"
  }
}
