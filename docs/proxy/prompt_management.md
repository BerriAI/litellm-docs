...
-d '{'model': 'gpt-4o-mini', 'messages': <YOUR LANGFUSE PROMPT TEMPLATE>}'
```
...
```python
litellm.completion(
    model="langfuse/gpt-4o-mini", # or `langfuse/anthropic/claude-sonnet-4-5`
    # ...
)
```
