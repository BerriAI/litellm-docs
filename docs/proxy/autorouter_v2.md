...
| Feature      | Auto Router v1 (semantic)      | Auto Router v2                                                             |
| ------------ | ------------------------------ | -------------------------------------------------------------------------- |
...
Three ways to pick a tier. Pick one; v2 falls back to the heuristic scorer if the LLM classifier errors or if no keyword rule matches.
...
- Semantic Auto Router (v1): [Auto Routing](/docs/proxy/auto_routing)
