...
| TOKEN_COUNTER_MAX_EXACT_CHARS | Characters per string above which the local token counter tokenizes only that many characters and scales the count by the string's length. Default is 4000000
