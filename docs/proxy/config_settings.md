...
| heuristic_v2_router_limit | Optional[HeuristicV2RouterLimit] | SDK only. Legacy name for the `auto_router_capability_limit` ceiling on `classifier_type: heuristic_v2` routers. Use `auto_router_capability_limit` for new SDK configurations. |
