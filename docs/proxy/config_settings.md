...
| ALERTING_WEBHOOK_URL | Provider-neutral webhook URL for Slack-format alerts (works with any Slack-compatible receiver such as Rocket.Chat or Mattermost), read only when `SLACK_WEBHOOK_URL` is unset
