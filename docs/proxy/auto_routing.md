...
For the LLM classifier, keyword rules, semantic matching, multi-model tier pools, adaptive Thompson sampling, session affinity, and the `cause=` decision log, see [Auto Router v2](./autorouter_v2.md).
