...
**Solution:** Use the `encrypted_content_affinity` pre-call check <SinceVersion v="1.82.3" /> to automatically route follow-up requests containing encrypted items to the correct deployment:
