...
general_settings:
  ...
  max_failed_login_attempts_per_source_overrides:
    ...
    "198.51.100.4": 1000000             # a scanner you run yourself, exempt from both limits
```
