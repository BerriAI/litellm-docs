...
gpt4 = guidance.llms.OpenAI("gpt-4o", api_base="http://0.0.0.0:4000", api_key="anything")
...
Pass model as a string of comma separated value of models. Example `"model"="llama3,gpt-4o-mini"`
