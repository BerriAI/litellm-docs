...
```bash
# OpenAI
MODEL=gpt-5.6-terra python scalekit_agent.py

# Anthropic
MODEL=anthropic/claude-sonnet-5 python scalekit_agent.py

# AWS Bedrock
MODEL=bedrock/us.anthropic.claude-sonnet-5 python scalekit_agent.py

# Via LiteLLM Proxy
OPENAI_API_BASE=http://localhost:4000 OPENAI_API_KEY=sk-1234 MODEL=claude-sonnet-5 python scalekit_agent.py
```
