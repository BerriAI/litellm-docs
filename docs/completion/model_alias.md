...
The model name you show an end-user might be different from the one you pass to LiteLLM - e.g. Displaying `GPT-5.6` while calling `gpt-5.6-luna` on the backend. 
