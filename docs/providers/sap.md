...
try:
    ...
    print("  2. Check that 'gpt-5.6-terra' is deployed in your resource group")
...
client.chat.completions.create(
    model="gpt-5.6-terra",  # ✓ Correct for proxy usage
    messages=[...]
)
```
...
# In case of error with the first configuration (model gpt-5.6-terra), the fallback module is used.
