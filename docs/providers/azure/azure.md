...
Azure also supports Claude models via Azure Foundry. Use `azure/claude-*` model names (e.g., `azure/claude-sonnet-5`) with Azure authentication. See the [Azure Anthropic documentation](./azure_anthropic) for details.
