...
response = litellm.completion(model="gpt-4o-mini", messages=[{"role": "user", 
...
response = litellm.completion(model="gpt-4o-mini", messages=[{"role": "user", "content": "Hey, how's it going?"}])
```
