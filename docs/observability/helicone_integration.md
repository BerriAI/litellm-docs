...
<Tabs>
  ...
  litellm.metadata = {
      ...
      "Helicone-Model-Override": "gpt-4o-mini",  # Override the model used for cost calculation
...
<Tabs>
  ...
  response = client.chat.completions.create(
      model="gpt-4o",  # This gets logged to Helicone
...
<Tabs>
  ...
  default_litellm_params:
    headers:
      ...
      helicone-retry-num: "3"
      helicone-retry-factor: "2"
      Helicone-Fallbacks: '["gpt-4o-mini", "gpt-4o"]'
