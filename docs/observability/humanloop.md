...
-d '{'model': 'gpt-4o-mini', 'messages': <YOUR HUMANLOOP PROMPT TEMPLATE>}'
```
...
```python
litellm.completion(
    model="humanloop/gpt-4o-mini", # or `humanloop/anthropic/claude-sonnet-4-5`
    # ...
)
```
...
```bash
{
  ...
  "model": "gpt-4o-mini" # your template model
}
```
