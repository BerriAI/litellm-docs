...
```bash
curl 'http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:countTokens?key=sk-anything' \
...
```bash
http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:countTokens?key=anything' \
-H 'Content-Type: application/json' \
-d '{
    "contents": [{
        "parts":[{
...
```bash
curl http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:countTokens?key=anything \
    -H 'Content-Type: application/json' \
    -X POST \
    -d '{
      "contents": [{
...
```bash
curl https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:countTokens?key=$GOOGLE_API_KEY \
    -H 'Content-Type: application/json' \
    -X POST \
    -d '{
      "contents": [{
...
```bash
curl "http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:generateContent?key=anything" \
    -H 'Content-Type: application/json' \
    -X POST \
    -d '{
      "contents": [{
...
```bash
curl -X POST "http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:generateContent?key=anything" \
-H 'Content-Type: application/json' \
-d '{
      "contents": [
        {
...
```bash
http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:countTokens?key=sk-1234ewknldferwedojwojw' \
-H 'Content-Type: application/json' \
-d '{
    "contents": [{
        "parts":[{
...
```bash
curl 'http://0.0.0.0:4000/gemini/v1beta/models/gemini-2.5-flash:generateContent?key=sk-anything' \
-H 'Content-Type: application/json' \
