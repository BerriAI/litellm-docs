...
# call gpt-4o - always add 'litellm_proxy/' in front of the model name
uv run interpreter --model litellm_proxy/gpt-4o
...
# call claude-sonnet-4-5 - always add 'litellm_proxy/' in front of the model name
uv run interpreter --model litellm_proxy/claude-sonnet-4-5
```
