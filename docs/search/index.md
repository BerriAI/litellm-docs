...
| `search_provider` | string | Yes (SDK) | The search provider to use: `"perplexity"`, `"tavily"`, `"parallel_ai"`, `"exa_ai"`, `"brave"`, `"google_pse"`, `"dataforseo"`, `"firecrawl"`, `"searxng"`, `"linkup"`, `"duckduckgo"`, `"searchapi"`, `"serper"`, `"you_com"`, `"apiserpent"`, or `"agentcore"` |
...
| Web Search on Amazon Bedrock (AgentCore) | `AGENTCORE_GATEWAY_URL` (required; auth via AWS credential chain or `AGENTCORE_GATEWAY_TOKEN`) | `agentcore` |
