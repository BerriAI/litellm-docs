...
This integration is proposed in [LiteLLM PR #42583](https://github.com/BerriAI/litellm/pull/42583). Use a build containing that change; it is not available in released versions yet
