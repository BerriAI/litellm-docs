...
items={[
  ...
  { icon: "📈", title: "Arize AX", description: "Hosted LLM observability and evaluation.", to: "/docs/observability/opentelemetry_v2#2-send-traces-to-a-specific-tool-presets" },
  { icon: "🔥", title: "Arize Phoenix", description: "Open-source tracing and evaluation.", to: "/docs/observability/opentelemetry_v2#2-send-traces-to-a-specific-tool-presets" },
