...
const OUTPUT_URL = new URL('../data/releases.snapshot.js', import.meta.url);
const RELEASE_COUNT = 10;
const HEADER = '// Generated by scripts/update-releases.mjs. Do not edit by hand.\n';
...
async function generateSnapshot() {
  ...
  return `${HEADER}export const releaseSnapshot = ${JSON.stringify(snapshot, null, 2)};\n`;
}
...
if (process.argv.includes('--check')) {
  ...
  if (current !== snapshot) {
    console.error('Rust migration releases are stale. Run npm run update:rust-migration');
    process.exitCode = 1;
  }
} else {
