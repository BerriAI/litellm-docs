...
- **The non-LLM heuristic classifier baselines at 45%.** It scores locally, so it is a solid option when you want zero added latency and zero cost. An LLM classifier buys you the jump from 45% to 64%
