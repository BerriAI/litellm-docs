---
slug: heuristic-v2
title: "Introducing Heuristic v2: More Solves, 45% Lower Cost"
date: 2026-09-02T10:00:00
authors:
  - tin
image: ./hero.png
description: "Heuristic v2 is a new classifier for LiteLLM's Auto Router that estimates each tier's odds of success instead of scoring prompt complexity. On a 21-task Terminal-Bench 2.0 subset it solved 3 more tasks than Heuristic v1, at 45% lower cost per solved task and lower latency."
